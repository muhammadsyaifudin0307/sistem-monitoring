...
const TableProduk = () => {
  ...
  const handleEditSave = (updatedProduct) => {
    ...
    toast.success(`${updatedProduct.name} berhasil diperbarui!`); // Tampilkan toast sukses
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="search-input flex items-center border border-zinc-100 rounded overflow-hidden" style={{ height: '40px' }}>
  ...
  <select
    className="p-2 outline-none bg-zinc-600 border-l border-zinc-100 font-semibold text-zinc-100 "
    style={{ height: '100%' }}
  >
    ...
    <option value="makanan">Makanan</option>
      ...
      {selectedProduct && (
        <ModalEditBarangMasuk
          ...
          product={selectedProduct} // Pastikan untuk mengirimkan produk yang valid
