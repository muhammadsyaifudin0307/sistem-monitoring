...
import ModalAddProduk from '../modal/add produk/ModalAddProduk';
...
const TableProduk = () => {
  ...
  const [data, setData] = useState([ // Gunakan state untuk data produk
    { id: 1, code: 'S0019', name: 'Hans Burger', img: 'https://randomuser.me/api/portraits/men/1.jpg' },
    { id: 2, code: 'S0020', name: 'Jolina Angelle', img: 'https://randomuser.me/api/portraits/women/1.jpg' },
  ...
  const handleAddProduct = (newProduct) => {
    setData((prevData) => [...prevData, { ...newProduct, id: prevData.length + 1 }]); // Tambahkan ID baru
          ...
          {currentData.map((item, index) => (
            <tr key={item.id} className="border-b border-zinc-600">
              ...
              <td className="py-3 px-6">
                <img className="w-20 h-20 rounded-md mx-auto" src={item.img} alt={item.name} />
              </td>
